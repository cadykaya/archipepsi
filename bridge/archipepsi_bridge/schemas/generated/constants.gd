...
const FEATURE_MIN_DEPTH = {"grapple_anchor": 5.4, "breakable_wall": 6.6, "water_volume": 5.6, "rail": 11.0, "wind_volume": 5.6, "bounce_pad": 5.2, "moving_platform": 5.6, "powered_door": 11.0}
const FEATURE_MIN_DEPTH_BESIDE_DOOR = {"grapple_anchor": 9.2, "breakable_wall": 11.6, "water_volume": 9.6, "rail": 20.4, "wind_volume": 9.6, "bounce_pad": 8.8, "moving_platform": 9.6, "powered_door": 20.4}
...
const LAUNCH_CORRECTION_SPEED = 2.0
...
const MAX_AUTHORED_HEIGHT = 80.0
const MAX_AUTHORED_SPAN = 96.0
...
const MIN_FEATURE_CHAMBER_DEPTH = 5.2
const MIN_FEATURE_CHAMBER_DEPTH_BESIDE_DOOR = 8.8
...
const PROCEDURAL_ARENA_MAX_HEIGHT = 8.0
...
const TOWER_MIN_FLOORS = 2
const WALK_SPEED = 7.0
const WORST_CASE_ENCOUNTER_TTK_BUDGET = 40.0
const WS_INBOUND_BUFFER_BYTES = 8388608
