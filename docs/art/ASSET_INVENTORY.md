...
## 0. Batch 001 — built, pending review

| ID | L | Scope | Category | Tris | Size (m) | Anchor | Model | Tex | Rev |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `epsilon_a_lectern` | L4 | H | hero | 140 | 1.18 × 0.86 × 2.62 | floor | B1 | B1 | PEND |
| `epsilon_b_core` | L4 | H | hero | 136 | 1.25 × 0.98 × 2.55 | floor | B1 | B1 | PEND |
| `epsilon_c_aperture` | L4 | H | hero | 188 | 1.34 × 0.50 × 2.77 | floor | B1 | B1 | PEND |
| `check_a_pedestal` | L2 | U | hero | 248 | 1.22 × 1.22 × 2.23 | floor | B1 | B1 | PEND |
| `check_b_vault` | L2 | U | hero | 232 | 1.38 × 1.37 × 2.16 | floor | B1 | B1 | PEND |
| `check_c_mast` | L2 | U | hero | 268 | 1.11 × 1.14 × 2.22 | floor | B1 | B1 | PEND |
| `portal_a_blast` | L2 | U | interactable | 252 | 3.54 × 1.02 × 4.60 | floor | B1 | B1 | PEND |
| `portal_b_collar` | L2 | U | interactable | 308 | 3.50 × 1.25 × 4.36 | floor | B1 | B1 | PEND |
| `enemy_melee_a_stooped` | L0 | U | enemy | 448 | 0.77 × 0.57 × 1.57 | floor | B1 | B1 | PEND |
| `enemy_melee_b_tripod` | L0 | U | enemy | 240 | 0.69 × 0.58 × 1.58 | floor | B1 | B1 | PEND |
| `enemy_melee_c_squat` | L0 | U | enemy | 396 | 0.79 × 0.71 × 1.29 | floor | B1 | B1 | PEND |
| `anchor_a_soffit` | L2 | U | interactable | 160 | 1.10 × 1.10 × 1.00 | **ceiling** | B1 | B1 | PEND |
| `anchor_b_jib` | L2 | U | interactable | 168 | 1.15 × 0.60 × 1.02 | **ceiling** | B1 | B1 | PEND |
| `arch_wall_panel` | L1 | U | module | 12 | 4.00 × 0.40 × 4.00 | floor | B1 | B1 | PEND |
| `arch_floor_slab` | L1 | U | module | 12 | 4.00 × 4.00 × 0.40 | floor | B1 | B1 | PEND |
| `arch_ceiling_beam` | L1 | U | module | 40 | 4.00 × 4.00 × 0.70 | **ceiling** | B1 | B1 | PEND |
| `arch_doorway` | L1 | U | module | 96 | 4.00 × 0.55 × 4.00 | floor | B1 | B1 | PEND |
| `arch_trim_rail` | L1 | U | module | 20 | 4.00 × 0.12 × 0.48 | floor | B1 | B1 | PEND |
| `arch_railing` | L1 | U | module | 96 | 4.00 × 0.11 × 1.05 | floor | B1 | B1 | PEND |
| `arch_pipe_run` | L1 | U | module | 172 | 4.00 × 0.40 × 0.62 | **module_floor** | B1 | B1 | PEND |
...
| `theme_void_glitch_{wall,floor,trim,accent}` | — | T | material | — | 128px / 4.0 m | — | — | B1 | PEND |

Metrics are read from the `manifest.json` beside each family and are
regenerated by the build. Live numbers, not transcribed ones.
