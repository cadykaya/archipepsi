...
| `signage_module` | L0 | U | `chamber_builders.gd` `GRAFFITI` | B | **ARCHITECTURE ACCEPTED 2026-08-29 (owner)** — becomes the four-module family `nav_blade`, `nav_panel`, `nav_chevron`, `nav_hanger`. Direction stays placement/runtime truth and is NOT baked into the primary sign mesh; runtime wording stays runtime-owned. **The four assets themselves remain PENDING owner visual review (Batch 022) and are NOT marked PASS.** | `docs/art/review/batch022` |
