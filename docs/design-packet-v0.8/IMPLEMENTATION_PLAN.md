...
3. `python -m pytest` on the packet's schema tests — 127 tests, all green, before anything else is written. They pass both standalone and from the repo root; if they do not, you copied them wrong.
