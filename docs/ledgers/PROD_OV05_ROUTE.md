...
- The same room also holds the last batch's plate-and-shutter branch
  (P14), composed here by the same profile.
...
- **The three minors (Passing Platforms, Counterfire Arcade, Unweighted
  Switch) are still separate launchers**, as before.
