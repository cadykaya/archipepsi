...
| File | What it is |
|---|---|
| [`00_ZERO_GUESSWORK_STANDARD.md`](00_ZERO_GUESSWORK_STANDARD.md) | v1.1. The bar all five must clear, and the six-pass audit that proves it. Read this first — it defines what "complete" means here. |
