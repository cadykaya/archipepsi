...
| **Audited commit SHA** | **`ff7ffae161064a894fc093f63e16ab1b880aef89`** (pass 6, the §30.11.2d/2e corrections and §30.12) |
| **Date** | 2026-09-11 |
| **Prior audited revisions** | `487a644` (pass 3), `950a561` (pass 4 before the connector reconciliation), `e7e6c7d` (pass 4 final), `35e131b` (pass 5), `02646f6` (pass 6, first half) |
