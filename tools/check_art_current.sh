...
for script in build_materials build_architecture build_props \
              ...
              build_theme_dressing build_lights build_shells build_arenas build_paths build_towers build_rooms build_arch_kit build_arch_services build_navigation build_landmarks build_epsilon_states build_forge build_checkpoint; do
