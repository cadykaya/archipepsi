...
# O05-08: PUSH and PULL, runtime only (Design 2 §14.2-14.4), by direct
# invocation. No Echo Action reaches them; see PROD_OV05.md, O05-08.
godot-verb-runtime: godot-import  # the impulse verbs, not their delivery
